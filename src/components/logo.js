...
export const PPLogo = (logoColor: string, PAYPAL_LOGO: string): HTMLElement => {
  ...
  const primary =
    (PP_LOGO_COLORS[logoColor] && PP_LOGO_COLORS[logoColor].primary) ||
    "#009cde";
  const secondary =
    (PP_LOGO_COLORS[logoColor] && PP_LOGO_COLORS[logoColor].secondary) ||
    "#012169";
  const tertiary =
    (PP_LOGO_COLORS[logoColor] && PP_LOGO_COLORS[logoColor].tertiary) ||
    "#003087";
  const primaryOpacity =
    (PP_LOGO_COLORS[logoColor] && PP_LOGO_COLORS[logoColor].primaryOpacity) ||
    "1";
  const secondaryOpacity =
    (PP_LOGO_COLORS[logoColor] && PP_LOGO_COLORS[logoColor].secondaryOpacity) ||
    "1";

...
export const eligiblePersonalizations = ({
  personalizations = [],
  props,
}: {|
  personalizations: $ReadOnlyArray<Personalization>,
  props: ButtonProps,
|}): $ReadOnlyArray<Personalization> => {
...
export const fetchPersonalizations = ({
  mlContext,
  eligibility,
  extra,
}: {|
...
|}): ZalgoPromise<$ReadOnlyArray<Personalization>> => {
  return getPersonalizations({ mlContext, eligibility, extra }).then(

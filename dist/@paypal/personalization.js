!function(root, factory) {
    "object" == typeof exports && "object" == typeof module ? module.exports = factory() : "function" == typeof define && define.amd ? define("@paypal/personalization", [], factory) : "object" == typeof exports ? exports["@paypal/personalization"] = factory() : root["@paypal/personalization"] = factory();
    ...
    return function(modules) {
        ...
        __webpack_require__.d(__webpack_exports__, "LocationType", (function() {
            return LocationType;
        }));
        __webpack_require__.d(__webpack_exports__, "callGraphQL", (function() {
            return callGraphQL;
        }));
        __webpack_require__.d(__webpack_exports__, "getPersonalizations", (function() {
            return getPersonalizations;
        }));
        __webpack_require__.d(__webpack_exports__, "getLogger", (function() {
            return getLogger;
        }));
        __webpack_require__.d(__webpack_exports__, "fetchPersonalizations", (function() {
        ...
        function buildPayPalUrl(path) {
            void 0 === path && (path = "");
            return "https://www.paypal.com" + path;
        }
        ...
        function callGraphQL(_ref) {
            ...
            return request({
                ...
                if (200 !== status) throw new Error(URI.GRAPHQL + " returned status " + status);
                return body.data;
            }));
        }
        function getPersonalizations(_ref3) {
            var mlContext = _ref3.mlContext, eligibility = _ref3.eligibility, extra = _ref3.extra;
            var variables = {
                clientId: mlContext.clientId,
                locale: mlContext.locale,
                buyerCountry: mlContext.buyerCountry,
                currency: mlContext.currency,
                intent: extra.intent,
                commit: extra.commit,
                vault: extra.vault,
                ip: mlContext.buyerIp,
                cookies: mlContext.cookies,
                userAgent: mlContext.userAgent,
                buttonSessionID: extra.buttonSessionID,
                renderedButtons: extra.renderedButtons,
                label: extra.label,
                period: extra.period,
                taglineEnabled: extra.taglineEnabled,
                layout: extra.layout,
                buttonSize: extra.buttonSize,
                eligibility: eligibility
            };
            eligibility ? variables.eligibility = eligibility : delete variables.eligibility;
            return callGraphQL({
                ...
                if (!gqlResult || !gqlResult.checkoutCustomization) throw new Error("GraphQL checkoutCustomization returned no checkoutCustomization object");
                return function(personalization) {
                    var personalizations = [];
                    Object.keys(personalization).forEach((function(experiment) {
                        personalization[experiment] && personalizations.push({
                            name: experiment,
        ...
        function fetchPersonalizations(_ref) {
            return getPersonalizations({
                mlContext: _ref.mlContext,

...
describe(`personalization cases`, () => {
  ...
  it("should successfully fetch a personalization payload", async () => {
    ...
    const mlContext = {
      ...
      clientId:
        "ARSwS0VNqpmnu-zumKX2ZNxfKLHV9M86WS61-hWy8iMezFS8wIoFaFSwIiiKo2t73O1K_zQ6n6WbrYBD",
      buyerIp: "",
      currency: "USD",
    ...
    await fetchPersonalizations({ mlContext, eligibility: {}, extra }).then(
      (experiments) => {
        let found = false;
        experiments.forEach((experiment) => {
          if (
            experiment.name === "tagline" &&

# Contributing to paypal-personalization
...
```bash
# Clone it
$ git clone https://github.com:<your_repo>/paypal/paypal-personalization.git

# Change directory
$ cd paypal-personalization

# Add the upstream repo
$ git remote add upstream https://github.com/paypal/paypal-personalization.git
